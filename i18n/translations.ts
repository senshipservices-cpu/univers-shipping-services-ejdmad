...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    becomeAgent: {
      ...
      subtitle: 'Rejoignez le réseau international d\'Univers Shipping Services et représentez nos services dans votre port.',
      introduction: 'Nous construisons un réseau global d\'agents maritimes, logisticiens, consignataires et transitaires dans les principaux ports du monde. En devenant agent 3S, vous bénéficiez d\'une visibilité internationale, de flux de clients B2B et d\'un support opérationnel depuis notre siège.',
  ...
  en: {
    ...
    becomeAgent: {
      title: 'Become a 3S Partner Agent',
      subtitle: 'Join the international network of Univers Shipping Services and represent our services in your port.',
      introduction: 'We are building a global network of maritime agents, logisticians, ship agents and freight forwarders in the world\'s major ports. By becoming a 3S agent, you benefit from international visibility, B2B client flows and operational support from our headquarters.',
  ...
  es: {
    ...
    becomeAgent: {
      title: 'Conviértete en Agente Asociado 3S',
      subtitle: 'Únete a la red internacional de Univers Shipping Services y representa nuestros servicios en tu puerto.',
      introduction: 'Estamos construyendo una red global de agentes marítimos, logísticos, consignatarios y transitarios en los principales puertos del mundo. Al convertirte en agente 3S, te beneficias de visibilidad internacional, flujos de clientes B2B y soporte operacional desde nuestra sede.',
  ...
  ar: {
    ...
    becomeAgent: {
      title: 'كن وكيلاً شريكاً 3S',
      subtitle: 'انضم إلى الشبكة الدولية لخدمات الشحن العالمية ومثل خدماتنا في ميناءك.',
      introduction: 'نحن نبني شبكة عالمية من الوكلاء البحريين واللوجستيين والوكلاء البحريين ووكلاء الشحن في الموانئ الرئيسية في العالم. من خلال أن تصبح وكيلاً 3S، تستفيد من الرؤية الدولية وتدفقات العملاء B2B والدعم التشغيلي من مقرنا الرئيسي.',
