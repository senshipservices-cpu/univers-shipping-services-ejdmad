        ...
        {!profileLoading && !profileError && profileData && (
          <View style={styles.contentContainer}>
            ...
            <View style={styles.section}>
              ...
              <GlassView style={styles.secondaryActionButton} glassEffectStyle="regular">
                <TouchableOpacity
              ...
              {/* Logout Button */}
              <TouchableOpacity
                style={[styles.actionButton, { backgroundColor: colors.error, opacity: isLoggingOut ? 0.6 : 1 }]}
                onPress={confirmLogout}
                activeOpacity={0.7}
                disabled={isLoggingOut}
              >
