  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.colors.background }]} edges={['top']}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <GlassView 
              style={[
                ...
                { borderColor: touched.name && errors.name ? colors.error : 'transparent' }
              ]}
          ...
          <View style={styles.fieldContainer}>
            ...
            <GlassView 
              style={[
                styles.inputContainer,
                { borderColor: touched.email && errors.email ? colors.error : 'transparent' }
              ]}
              glassEffectStyle="regular"
            >
              <IconSymbol
          ...
          <View style={styles.fieldContainer}>
            ...
            <GlassView 
              style={[
                styles.inputContainer,
                { borderColor: touched.phone && errors.phone ? colors.error : 'transparent' }
              ]}
              glassEffectStyle="regular"
            >
              <IconSymbol
          ...
          <View style={styles.fieldContainer}>
            ...
            <GlassView 
              style={[
                ...
                { borderColor: touched.account_type && errors.account_type ? colors.error : 'transparent' }
              ]}
              glassEffectStyle="regular"
            >
              <IconSymbol
      ...
      <View style={[styles.buttonContainer, { backgroundColor: theme.colors.background }]}>
        ...
        {/* Cancel Button */}
        <GlassView style={styles.cancelButtonGlass} glassEffectStyle="regular">
          <TouchableOpacity
